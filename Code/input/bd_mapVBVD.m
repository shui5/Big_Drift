function twix_obj = bd_mapVBVD(filename,varargin)
...
for s=1:NScans
    ...
    rstraj = [];
    if arg.bReadHeader
        [twix_obj{s}.hdr, rstraj] = bd_read_twix_hdr(fid);
    end

    % declare data objects:
    twix_obj{s}.image         = bd_twix_map_obj(arg,'image',filename,version,rstraj);
    twix_obj{s}.noise         = bd_twix_map_obj(arg,'noise',filename,version);
    twix_obj{s}.phasecor      = bd_twix_map_obj(arg,'phasecor',filename,version,rstraj);
    twix_obj{s}.phasestab     = bd_twix_map_obj(arg,'phasestab',filename,version,rstraj);
    twix_obj{s}.phasestabRef0 = bd_twix_map_obj(arg,'phasestab_ref0',filename,version,rstraj);
    twix_obj{s}.phasestabRef1 = bd_twix_map_obj(arg,'phasestab_ref1',filename,version,rstraj);
    twix_obj{s}.refscan       = bd_twix_map_obj(arg,'refscan',filename,version,rstraj);
    twix_obj{s}.refscanPC     = bd_twix_map_obj(arg,'refscan_phasecor',filename,version,rstraj);
    twix_obj{s}.refscanPS     = bd_twix_map_obj(arg,'refscan_phasestab',filename,version,rstraj);
    twix_obj{s}.refscanPSRef0 = bd_twix_map_obj(arg,'refscan_phasestab_ref0',filename,version,rstraj);
    twix_obj{s}.refscanPSRef1 = bd_twix_map_obj(arg,'refscan_phasestab_ref1',filename,version,rstraj);
    twix_obj{s}.RTfeedback    = bd_twix_map_obj(arg,'rtfeedback',filename,version,rstraj);
    twix_obj{s}.vop           = bd_twix_map_obj(arg,'vop',filename,version); % tx-array rf pulses
